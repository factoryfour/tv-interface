...
describe('Schema Methods', function() {
    ...
    it('schemaTests-01 - should list all schemas', function(done) {
        tvInterface.getAllSchemas(created_vault_id, function(error, results) {
            should.not.exist(error);
    ...
    it('schemaTests-04 - should be able to update schema', function(done) {
        tvInterface.updateSchema(created_vault_id, created_schema_id, org_schema, function(error, results) {
            should.not.exist(error);
